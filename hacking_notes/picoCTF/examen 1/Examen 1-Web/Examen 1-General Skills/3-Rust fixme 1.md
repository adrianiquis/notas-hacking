...
#Inspeccionamos el archivo con cargo

┌──(flavio㉿kali)-[~/picoCTF/Examen1/fixme1]
└─$ cargo check                                   
...
Usamos cargo para verificar la integridad del archivo, nos da errores de sintaxis y cuando los arreglamos nos arroja la flag.
## Referencias
